<?php 
require "admin/staf/function/functions.php";
...
<body>
    ...
    <!-- Start Breadcrumb 
    ============================================= -->
    <div class="breadcrumb-area text-center shadow dark bg-fixed text-light" style="background-image: url(assets/img/banner_profile.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h1>PERSONAL PENGELOLAAN BPP</h1>
                    <ul class="breadcrumb">
                        <li><a href="#"><i class="fas fa-home"></i> Home</a></li>
                        <li class="active">Profil Sumberdaya Manusia</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="team-items text-center">
                <div class="row">
                    ...
                    <div class="single-item col-lg-4 col-md-6">
                        <div class="item">
                            <div class="thumb">
                                <img src="admin/staf/assets/img/<?=$row['gambar']?>" alt="Thumb" height="400px">
                            </div>
                            <div class="info">
                                <span><?=strtoupper($row['jabatan'])?></span>
                ...
                <div class="mb-3">
                    <img src="assets/img/wilayah.jpg" alt="wilayah">
                </div>
            </div>
        </div>
    </div>
